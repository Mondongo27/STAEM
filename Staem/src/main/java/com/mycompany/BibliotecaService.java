...
public class BibliotecaService {
    ...
    // También necesitaremos obtener los datos actuales para el formulario
    ...
    public Map<String, Object> obtenerDetallesGlobalesJuego(String titulo) {
        ...
        // Cálculos de valoración global
        double notaUsuarios = (contador > 0) ? (sumaNotas / contador) : 0;
        double notaExpertos = 4.5; // Valor fijo que "ponemos nosotros"
        double notaPremium = 5.0;  // Valor para los que han pagado por mejor valoración

        // Fórmula: 40% usuarios + 40% expertos + 20% premium
        double notaGlobal = (notaUsuarios * 0.4) + (notaExpertos * 0.4) + (notaPremium * 0.2);
